...
def up_cmd(agentfile_path: str, tag: str, detach: bool) -> None:
    ...
    console.print(f"    ninetrix invoke --chat                  interactive chat")
    console.print(f"    ninetrix invoke -m \"your task\"           single message")
    console.print("    ninetrix status                          container health")
    console.print("    ninetrix logs --follow                   stream logs")
    console.print("    ninetrix down                            stop all\n")
